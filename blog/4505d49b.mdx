...
$$
\begin{equation}
\boldsymbol{x}_{t+1}  =  \boldsymbol{x}_{t}-\alpha \nabla_{\boldsymbol{x}_{t}} f\left(\boldsymbol{x}_{t}\right) \tag{1}\tag{1}
\end{equation}
$$
...
$$
\begin{equation}
\frac{d \boldsymbol{x}_{t}}{d t}=-\nabla_{\boldsymbol{x}_{t}} f\left(\boldsymbol{x}_{t}\right) \tag{2}\tag{2}
\end{equation}
$$
:::tip 推导过程
