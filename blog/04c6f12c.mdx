...
$$
\begin{equation}
P(Y \mid \theta)=\sum_{Z} P(Z \mid \theta) P(Y \mid Z, \theta)\tag{1}
\end{equation}
$$
即
...
$$
\begin{equation}
\hat{\theta}=\arg \max _{\theta} \log P(Y \mid \theta)\tag{2}
\end{equation}
$$
...
$$
\begin{equation}
p(\boldsymbol{y})=\sum_{i=1}^{K} \phi_{i} \mathcal{N}\left(\boldsymbol{\mu}_{i}, \boldsymbol{\Sigma}_{i}\right)\tag{3}
\end{equation}
$$
...
$$
\begin{equation}
p(\boldsymbol{y}) = \sum_{\boldsymbol{z}} p(\boldsymbol{y}\mid \boldsymbol{z}) p(\boldsymbol{z}) = \sum_{{\boldsymbol{z}}} \prod_{i=1}^{K}[\phi_{i}\mathcal{N}(\boldsymbol{y}\mid \boldsymbol{\mu}_{i}, \boldsymbol{\Sigma}_{i})]^{z_{i}}\tag{4}
\end{equation}
$$
