...
![image.png](https://images.puqing.work/2023/08/02/64ca4ff267584.webp)
...
记 $\Delta=\nabla \cdot \nabla=\frac{\partial^{2}}{\partial x^{2}}+\displaystyle\frac{\partial^{2}}{\partial y^{2}}+\frac{\partial^{2}}{\partial z^{2}}$，称为 **Laplace** 算子，而满足**Laplace**方程的函数：
